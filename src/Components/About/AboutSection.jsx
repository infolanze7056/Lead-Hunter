      ...
      <div className="lg:px-36 md:px-20 px-5 py-10">
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center">
            ...
            <div className="text-lg">
                ...
                <div>These opportunities led to Digitalzone transitioning from contributing to the partner networks of all the major demand gen vendors, to selling direct to businesses. It was born of a vision of transparency, cutting out the middleman to be more where it matters most - more agile, more responsive, more personalized, more compliant - without sacrificing on quality or inflating costs.</div>
            </div>
        </div>
      </div>
    </div>
