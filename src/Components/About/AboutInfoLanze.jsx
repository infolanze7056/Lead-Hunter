    ...
    <div className='font-family'>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center">
            ...
            <div className="text-lg lg:order-1">
                <div className="pb-4 lg:pe-4">Amidst all of the turbulence of 2024, InfoLanze Tech recognized a shift in the priorities of the modern B2B buyer. Digital consumers were expecting seamless brand experiences, privacy legislation was rapidly evolving, and CX was a clear miss across the industry.</div>
