    ...
    <div className='lg:px-36 md:px-20 px-5 pb-16 pt-14 font-family'>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">Transparent Pricing</h2>
            ...
            >
              {includedFeatures.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <IoMdCheckboxOutline className="h-6 w-5 flex-none text-indigo-600" aria-hidden="true" />
                  {feature}
                </li>
              ))}
            </ul>
