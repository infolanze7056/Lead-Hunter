          ...
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                Our diverse pricing models are tailored to suit your needs.
                Whether you're looking for SEO, social media marketing, content
                creation, or email marketing, LeadHunter has the solution for
                you. Let us help you reach your target audience effectively and
            ...
            <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-16 lg:mx-0 lg:flex lg:max-w-none">
              <div className="p-8 sm:p-10 lg:flex-auto">
                ...
                <p className="mt-6 text-base leading-7 text-gray-600">
                  At LeadHunter, we offer transparent pricing for our digital
                  marketing services. We work for you, which means we don't take
                  a percentage of your client fees. With us, you make one simple
                  and affordable payment for the services you need to grow your
                  business online.
                </p>
                <div className="mt-10 flex items-center gap-x-4">
                  <h4 className="flex-none text-sm font-semibold leading-6 text-[--three-color]">
                    What’s included
                  </h4>
                ...
                >
                  {includedFeatures.map((feature) => (
                    <li key={feature} className="flex gap-x-3">
                      <IoMdCheckboxOutline
                        className=" text-[--three-color] h-6 w-5 flex-none"
                        aria-hidden="true"
                      />
                      {feature}
                    </li>
