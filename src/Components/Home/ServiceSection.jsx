        ...
        <div className='lg:px-28 md:px-10 px-4 py-20'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-14 text-center'>
                <div className='lg:px-7'>
                    <div className=''><FaInbox className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
                ...
                <div className='lg:px-7'>
                    <div className=''><BsFillPersonCheckFill className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
                ...
                <div className='lg:px-7'>
                    <div className=''><MdAccessTime className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
                ...
                <div className='lg:px-7'>
                    <div className=''><IoMdCheckboxOutline className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
                ...
                <div className='lg:px-7'>
                    <div className=''><FiLock className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
                ...
                <div className='lg:px-7'>
                    <div className=''><GrDocumentText className='text-7xl bg-[--second-color] p-5 rounded-lg mx-auto' /></div>
